...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleEntidadeEmUsoException(EntidadeEmUsoException ex) {
		...
		Problem problem = new Problem(status.value(), OffsetDateTime.now(), detail, detail, detail, detail, null);
 ...
 * ResponseEntity<?> handleEntidadeEmUso(EntidadeEmUsoException ex, WebRequest
 * request) {
 * 
 * HttpStatus status = HttpStatus.CONFLICT; ProblemType problemType =
 * ProblemType.ENTIDADE_EM_USO; String detail = ex.getMessage();
 * 
 * Problem problem = createProblemBuilder(status, problemType, detail)
